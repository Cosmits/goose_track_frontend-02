import{s as P,a as u,j as h,P as Q,M as Wr,S as zr,T as Hr,U as vn,V as Kr,R as Ke,W as st,k as yt,X as Zt,Y as nr,Z as Ur,z as Gr,_ as qr,$ as Vr,Q as kn,a0 as Xr,N as Yr,r as Zr,B as wn}from"./index-d05e6ed2.js";import{_ as y,a as V,b as Qr,C as Jr}from"./CalendarToolBar-8de79dad.js";import{b as eo}from"./index-7a5acfa8.js";import"./index-61efe394.js";/* empty css                         */const to=P.section`
  width: 335px;
  height: 100%;
  margin: 0 auto;
  width: 375px;
...
`,ro=e=>u.createElement("svg",{viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",...e},u.createElement("path",{d:"M12 8V16M8 12H16M22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12Z",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round"})),oo=P.div`
  margin-bottom: 24px;
  width: 299px;
  height: 34px;
  display: flex;
...
`,Ac=P.p`
  ...
  font-weight: 600;
  line-height: ${()=>12/10};
`;function Br({taskTitle:e,priority:t,id:n}){const r=Gr(qr),o={low:"#72C2F8",medium:"#F3B249",high:"#EA3D65"};function i(s){const a=s.split("");return[a[0].toUpperCase(),...a.slice(1)].join("")}return h.jsx(Tc,{children:h.jsxs(Pc,{children:[h.jsx(Sc,{children:e}),h.jsxs($c,{children:[h.jsxs(Rc,{children:[h.jsx(Oc,{src:r}),h.jsx(jc,{color:o[t],children:h.jsx(Ac,{children:i(t)})})]}),h.jsx(_r,{id:n})]})]})})}Br.propTypes={taskTitle:Q.string.isRequired,priority:Q.string.isRequired,id:Q.string.isRequired};const Mc=P.ul`
  max-height: 40vh;
  width: 100%;
  display: flex;
  flex-direction: column;
...
`,Vc=P.button`
  ...
  border-radius: 8px;
  border: none;
`,Xc=({initialData:e,closeModal:t,category:n=""})=>{const{currentDay:r}=yt(),[o,i]=u.useState(!1),[s,a]=u.useState(!!e),[c,l]=u.useState(""),[f,{isError:p,error:m}]=Vr(),[w,{isError:g,error:d}]=nr(),{currentData:v}=Zt(r),[x,C]=u.useState(e||{title:"",start:"09:00",end:"09:30",priority:"low",date:r,category:""}),b=_=>{switch(_){case"To do":C({...x,category:"to-do"}),i(!1);break;case"In progress":C({...x,category:"in-progress"}),i(!1);break;case"Done":C({...x,category:"done"}),i(!1);break;default:{const T=v.data.filter(({_id:B})=>B===_);i(!0),C(...T);break}}};u.useEffect(()=>{b(n),e?(C(e),a(!0)):a(!1)},[n,e]),u.useEffect(()=>{p&&(console.log(m),kn.error("Error creating task")),g&&(console.log(d),kn.error("Error creating task"))},[m,p,d,g]);const E=()=>{w(x._id,x),t()},S=()=>{f(x),t()},$=_=>{const{name:T,value:B}=_.target;C({...x,[T]:B}),l("")},k=_=>{if(_.preventDefault(),!["to-do","in-progress","done"].includes(x.category)){l("Invalid category. Choose from: to-do, in-progress, done.");return}s?E():S(),C(e),a(!1)},D=()=>{t(),a(!1)};return h.jsxs(Fc,{children:[h.jsx(Nc,{onClick:()=>{t()}}),h.jsxs("form",{onSubmit:k,children:[h.jsxs(Dt,{children:["Title",h.jsx(Dc,{type:"text",name:"title",value:(x==null?void 0:x.title)||"",onChange:$,placeholder:"Enter text",required:!0,maxLength:"250"})]}),h.jsxs(Wc,{children:[h.jsxs(Dt,{children:["Start",h.jsx(er,{type:"time",name:"start",value:(x==null?void 0:x.start)||"",onChange:$,required:!0,pattern:"[0-1][0-9]:[0-5][0-9]"})]}),h.jsxs(Dt,{children:["End",h.jsx(er,{type:"time",name:"end",value:(x==null?void 0:x.end)||"",onChange:$,required:!0,pattern:"[0-1][0-9]:[0-5][0-9]",min:x==null?void 0:x.start})]})]}),h.jsxs(zc,{children:[h.jsxs(Wt,{children:[h.jsx(Hc,{type:"radio",name:"priority",value:"low",checked:(x==null?void 0:x.priority)==="low",onChange:$,required:!0}),"Low"]}),h.jsxs(Wt,{children:[h.jsx(Kc,{type:"radio",name:"priority",value:"medium",checked:(x==null?void 0:x.priority)==="medium",onChange:$,required:!0}),"Medium"]}),h.jsxs(Wt,{children:[h.jsx(Uc,{type:"radio",name:"priority",value:"high",checked:(x==null?void 0:x.priority)==="high",onChange:$,required:!0}),"High"]})]}),c&&h.jsx("div",{children:c}),h.jsxs(Gc,{children:[o?h.jsxs(Dr,{onClick:E,type:"submit",children:[h.jsx(Bc,{}),"Edit"]}):h.jsxs(qc,{onClick:S,type:"submit",children:[h.jsx(Lc,{}),"Add"]}),h.jsx(Vc,{type:"button",onClick:D,children:"Cancel"})]})]})]})},Yc=({initialData:e,closeModal:t,category:n})=>h.jsx(Xr,{onClose:t,children:h.jsx(Xc,{initialData:e,closeModal:t,category:n})}),Zc=Yc;function Qc(e,t){const n={"To do":[],"In progress":[],Done:[]};return e.map(r=>{const{category:o,date:i}=r;if(i===t)switch(o){case"to-do":n["To do"].unshift(r);break;case"in-progress":n["In progress"].unshift(r);break;default:n.Done.unshift(r);break}}),n}const Jc=P(Yr)`
  padding: 4px 6px;
  color: ${({theme:e})=>e.secondaryTextColor};
  transition:
