import{a as D,d as C,y as $,t as B,p as u,s as A}from"./index-c9acedb9.js";import{t as N,a6 as z,a8 as d,w as T,s as b,K as M,a as v,k as j,j as n,F as h,a9 as S}from"./index-d3fbb726.js";import{F as _,f as F,a as E}from"./index-d1828992.js";/* empty css                         */function w(e,t){if(N(2,arguments),!t||z(t)!=="object")return new Date(NaN);var o=t.years?d(t.years):0,r=t.months?d(t.months):0,s=t.weeks?d(t.weeks):0,l=t.days?d(t.days):0,y=t.hours?d(t.hours):0,c=t.minutes?d(t.minutes):0,p=t.seconds?d(t.seconds):0,k=T(e),f=r||o?D(k,r+o*12):k,m=l||s?C(f,l+s*7):f,g=c+y*60,a=p+g*60,i=a*1e3,x=new Date(m.getTime()+i);return x}function K(e,t){e.prototype=Object.create(t.prototype),e.prototype.constructor=e,$(e,t)}b.div`
  padding: 6px 12px;
  color: #ffffff;
  background: #3e85f3;
  border-radius: 8px;
