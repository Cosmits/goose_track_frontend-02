import{s as r,a as o,j as t,P as s,n as w,i as b,y as C,z as j,A as y}from"./index-18ebf305.js";const T=r.section`
...
`;function u({id:e}){const n={swipe:[t.jsx(P,{}),()=>{console.log(`swipe button click ${e}`)}],edit:[t.jsx(F,{}),()=>{console.log(`edit button click ${e}`)}],remove:[t.jsx(_,{}),()=>{console.log(`delete task ${e} success`)}]},i=Object.keys(n);return t.jsx(t.Fragment,{children:t.jsx(z,{children:i.map(a=>t.jsx(H,{children:t.jsx(D,{type:"button",onClick:n[a][1],children:n[a][0]})},a))})})}u.propTypes={id:s.string.isRequired};const O=r.li`
  flex-shrink: 0;
  width: 299px;
  height: 108px;
...
`;function f({filteredTasks:e}){const n=Object.keys(e);return t.jsx(X,{children:n.map(i=>t.jsx(m,{title:i,tasks:e[i]},i))})}f.propTypes={filteredTasks:s.objectOf(s.array).isRequired};function te(){const{currentDay:e}=j(),n={"To do":[],"In progress":[],Done:[]},{data:i}=y("2023-10");return i&&i.data.map(d=>{const{category:c,date:l}=d;if(l.split("-")[2]===e)switch(c){case"to-do":n["To do"].push(d);break;case"in-progress":n["In progress"].push(d);break;default:n.Done.push(d);break}}),t.jsx(T,{children:t.jsx(f,{filteredTasks:n})})}export{te as default};
