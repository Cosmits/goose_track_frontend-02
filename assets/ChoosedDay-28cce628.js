import{s as r,a as o,j as t,P as s,D as b,n as f,k as C,E as T,F as j,H as y}from"./index-8b24c812.js";const v=r.section`
...
`,$=e=>o.createElement("svg",{viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",...e},o.createElement("path",{d:"M12 8V16M8 12H16M22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12Z",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round"})),B=r.div`
  margin-bottom: 24px;
  width: 299px;
  height: 34px;
  display: flex;
...
`;function x({title:e,category:n}){return t.jsxs(B,{children:[t.jsx(E,{children:e}),t.jsx("button",{type:"button",onClick:()=>console.log(`Column Head Bar Add Task Btn click ${n}`),children:t.jsx(M,{})})]})}x.propTypes={title:s.string.isRequired,category:s.string.isRequired};const A=e=>o.createElement("svg",{viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",...e},o.createElement("g",{id:"plus"},o.createElement("path",{id:"Icon",d:"M12 5V19M5 12H19",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round"}))),I=r.button`
  width: 100%;
  height: 48px;
  display: flex;
  gap: 8px;
...
`;function u({id:e}){const[n]=b(e),i={swipe:[t.jsx(P,{}),()=>{console.log(`swipe button click ${e}`)}],edit:[t.jsx(_,{}),()=>{console.log(`edit button click ${e}`)}],remove:[t.jsx(O,{}),()=>{n(e)}]},d=Object.keys(i);return t.jsx(t.Fragment,{children:t.jsx(D,{children:d.map(a=>t.jsx(z,{children:t.jsx(F,{type:"button",onClick:i[a][1],children:i[a][0]})},a))})})}u.propTypes={id:s.string.isRequired};const G=r.li`
  flex-shrink: 0;
  width: 299px;
  height: 108px;
...
`,K=r.p`
  ...
  font-weight: 600;
  line-height: ${()=>12/10};
`;function k({taskTitle:e,priority:n,avatar:i,id:d}){const a={low:"#72C2F8",medium:"#F3B249",high:"#EA3D65"};function l(c){const p=c.split("");return[p[0].toUpperCase(),...p.slice(1)].join("")}return t.jsx(G,{children:t.jsxs(V,{children:[t.jsx(U,{children:e}),t.jsxs(Z,{children:[t.jsxs(N,{children:[t.jsx(Q,{src:i}),t.jsx(J,{color:a[n],children:t.jsx(K,{children:l(n)})})]}),t.jsx(u,{id:d})]})]})})}k.propTypes={taskTitle:s.string.isRequired,priority:s.string.isRequired,avatar:s.string.isRequired,id:s.string.isRequired};const X=f.ul`
  height: 40vh;
  width: 100%;
  display: flex;
  flex-direction: column;
...
`;function m({tasks:e}){const n=C(T);return t.jsx(X,{children:e.map(i=>{const{_id:d,title:a,priority:l}=i;return t.jsx(k,{id:d,taskTitle:a,priority:l,avatar:n},d)})})}m.propTypes={tasks:s.arrayOf(s.object).isRequired};function g({title:e,tasks:n}){return t.jsxs(L,{children:[t.jsx(x,{title:e,category:e}),n&&t.jsx(m,{tasks:n}),t.jsx(h,{category:e})]})}g.propTypes={title:s.string.isRequired,tasks:s.array.isRequired};const Y=r.ul`
  display: flex;
  gap: 16px;
  overflow-x: auto;
...
`;function w({filteredTasks:e}){const n=Object.keys(e);return t.jsx(Y,{children:n.map(i=>t.jsx(g,{title:i,tasks:e[i]},i))})}w.propTypes={filteredTasks:s.objectOf(s.array).isRequired};function re(){const{currentDay:e}=j(),n={"To do":[],"In progress":[],Done:[]},{currentData:i}=y(e);return i&&i.data.map(a=>{const{category:l,date:c}=a;if(c===e)switch(l){case"to-do":n["To do"].push(a);break;case"in-progress":n["In progress"].push(a);break;default:n.Done.push(a);break}}),t.jsx(v,{children:t.jsx(w,{filteredTasks:n})})}export{re as default};
